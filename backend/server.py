...
def seed_data(conn):
    cur = conn.cursor()
    products = [
        ("prod-001", "Batata Recheada De Carne Com Cheddar", "Batata recheada feita na hora, bem caprichada. Carne moida bem temperada com molho de tomate da casa cremoso envolvendo tudo, feito com carne, molho de tomate da casa, na finalizacao vai mussarela, cheddar nas bordas e cheiro verde. Aqui a gente nao economiza nao, e recheio generoso pra comer feliz do comeco ao fim.", 29.90, 10, "/images/products/batata-carne-cheddar.jpeg", "Batatas Recheadas 400g", 0, 1),
    ...
    for combo in combos:
        cur.execute("INSERT INTO combos VALUES (?,?,?,?,?,?,?,?,?)", combo)
    conn.commit()
