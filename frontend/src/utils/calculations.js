...
const DELIVERY_FEE_ENTRIES = [
  { name: 'Acude', fee: 10.0 },
  { name: 'Anhumas (Ate o Coro)', fee: 8.0 },
  { name: 'Anhumas (Igreja)', fee: 17.0 },
  { name: 'Anhumas (KM2)', fee: 12.0 },
  { name: 'Anhumas (Sta Cruz)', fee: 10.0, aliases: ['Anhumas (Santa Cruz)'] },
  { name: 'Anhumas (Ze M.)', fee: 15.0 },
  ...
  { name: 'Eldorado', fee: 8.0 },
  { name: 'Estancia', fee: 15.0, aliases: ['Estiva'] },
  { name: 'Estiva', fee: 8.0 },
  { name: 'Geriva', fee: 17.0 },
  { name: 'Geriva (Bar da Maia)', fee: 20.0 },
  { name: 'Geriva (Bar do Raul)', fee: 25.0 },
  { name: 'Ilheus', fee: 13.0 },
  { name: 'Imbel', fee: 8.0 },
  { name: 'Jarrinha', fee: 10.0 },
  { name: 'Jd. Alterosa', fee: 8.0, aliases: ['Jardim Alterosa'] },
  { name: 'Jd. America', fee: 7.0, aliases: ['Jardim America'] },
  { name: 'Jd. Bernadete', fee: 8.0, aliases: ['Jardim Bernadete'] },
  ...
  { name: 'Nsr. de Fatima', fee: 8.0, aliases: ['Nossa Senhora de Fatima'] },
  { name: 'Nsr. de Lourdes', fee: 7.0, aliases: ['Nossa Senhora de Lourdes'] },
  { name: 'Oriente', fee: 7.0 },
  { name: 'Pedra Mamona', fee: 12.0 },
  { name: 'Pedra Preta', fee: 20.0 },
  { name: 'Pedralva', fee: 18.0 },
  ...
  { name: 'Pouso Alegre', fee: 120.0 },
  { name: 'Prefeitura-Lago', fee: 9.0, aliases: ['Prefeitura Lago', 'Prefeitura'] },
  { name: 'Presidio', fee: 15.0 },
  { name: 'Reboredon', fee: 9.0, aliases: ['Reboredao'] },
  { name: 'Sta. Rita do Sapucai', fee: 70.0, aliases: ['Santa Rita do Sapucai'] },
...
export function getPaymentFeeDetails(paymentMethod = '', baseAmount = 0) {
  ...
  if (normalized.includes('CREDITO') || normalized.includes('DEBITO')) {
    const amount = Math.round(Math.max(0, Number(baseAmount) || 0) * 0.02 * 100) / 100;
    return {
      amount,
      label: 'TAXA MAQUININHA (2%)',
      description: 'Pagamentos no cr̩dito e d̩bito t̻m taxa de 2% da maquininha.',
    };
  }
  return {
    amount: 0,
...
export function calculatePaymentFee(paymentMethod = '', baseAmount = 0) {
  return getPaymentFeeDetails(paymentMethod, baseAmount).amount;
}
